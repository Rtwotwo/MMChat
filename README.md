...
Next, I will show some animations of using some functions of this software. You can try running the app_Experience these functions in the redal.py file.

| ![gesture control](assets/video/1.手势控制飞行.gif) | ![style transfer](assets/video/2.风格迁移.gif) |
| :---: | :---: |
| ![chat interface](assets/video/3.对话交流.gif) | ![object detection](assets/video/4.物体检测.gif) |
