...
from models.style_vgg_fixed import VGG_Fixed_Style_Transfer
from models.style_metanet_random import VGG,TransformNet, MetaNet
...
class ImageStyleTransferApp(tk.Frame):
    ...
    def __import_content_image__(self):
        ...
        if file_path:
            ...
            self.content_image.save(r"image_content\content_image.jpg")
            img_content = cv2.resize(cv2.cvtColor(cv2.imread(r"image_content\content_image.jpg"), 
    ...
    def __import_style_image__(self):
        ...
        if file_path:   
            ...
            self.style_image.save(r"image_style\style_image.jpg")
            if self.toggle_dynamic_style_transfer_active:
                # 如果开启动态迁移
            ...
            img_style = cv2.resize(cv2.cvtColor(cv2.imread(r"image_style\style_image.jpg"),
                                     cv2.COLOR_BGR2RGB), (200, 200)) 
