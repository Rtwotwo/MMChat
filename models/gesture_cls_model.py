...
class PatchEmbed(nn.Module):
    """Define the input feature point patch layer and divide the feature points
...
class VideoClassifierViT(nn.Module):
    """Define video classification ViT model structure"""
    def __init__(
    ...
    def forward(self, x):
        ...
        # LSTM processing time dimension
...
if __name__ == '__main__':
    ...
    # Export ONNX model for visualization
